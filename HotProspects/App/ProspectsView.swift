...
struct ProspectsView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .confirmationDialog("Filter by", isPresented: $isShowingFilter) {
                Button("Name")          { prospects.sort(by: .name) }
                Button("Email address") { prospects.sort(by: .emailAddress) }
                Button("Contacted")     { prospects.sort(by: .isContacted) }
            }
        }
    }
